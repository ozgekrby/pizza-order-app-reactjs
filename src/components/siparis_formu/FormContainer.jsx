...
export default function FormContainer() {
  ...
  return (
    <Form onSubmit={handleSubmit} className="form-container text-start" data-cy="pizza-order-form">
    <FormGroup className="form-group-container">
      <p className="bold-text" data-cy="pizza-name">{pizzaData.name}</p>
      ...
      <FormText className="light-text expl-text" data-cy="pizza-description">{pizzaData.text}</FormText>
    </FormGroup>
      ...
      <Col className="info-col">
        <FormGroup className="text-start">
          ...
          {touched.size && errors.size && (
            <p className="red-text" data-cy="error-size">{errors.size}</p>
          )}
        </FormGroup>
      </Col>
      ...
      <Col className="info-col">
        <FormGroup className="text-start">
          ...
          {touched.crust && errors.crust && (
            <p className="red-text" data-cy="error-crust">{errors.crust}</p>
          )}
          <Input
            id="crust-thickness"
            name="select"
    ...
    <FormGroup className="text-start">
      ...
      {touched.ext&& errors.ext && <p className="red-text" data-cy="error-extra">{errors.ext}</p>}
      {errors.ext10 && <p className="red-text" data-cy="error-extra">{errors.ext10}</p>}
      <Row className="info-row mobile-check">
        {pizzaData.extMal.map((extCheck, index) => (
          <Col key={index} xs="5" sm="4" className="info-col text-start d-flex align-items-center checks">
            <FormGroup check inline>
              <Input
                ...
                disabled={selectedExtra.length >= 10 && !selectedExtra.includes(extCheck)}
              />
    ...
    <FormGroup>
      ...
      {touched.nameArea && errors.nameArea && (
        <p className="red-text" data-cy="error-name">{errors.nameArea}</p>
      )}
      <Input
        id="isim"
        name="isim"
    ...
    <FormGroup className="info-form">
      <div className="counting">
        <Button color="warning" className="counting-item" onClick={decrement} data-cy="decrement-button">-</Button>
        <div className="counting-item counting-item-number" data-cy="item-count">{count}</div>
        <Button color="warning" className="counting-item" onClick={increment} data-cy="increment-button">+</Button>
      </div>
  
      <Card className="result-sum result-sum-card">
        <CardBody className="result-sum-card">
          <p className="bold-text result-header-text" data-cy="order-total-title">Sipariş Toplamı</p>
